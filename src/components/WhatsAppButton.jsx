...
const variants = {
  // Compact button for the header (min-h-11 = 44px touch target)
  header: 'justify-center min-h-11 px-4 py-2 text-sm rounded-full',
  // Large hero / contact-page CTA
  large: 'justify-center min-h-14 px-6 py-4 text-lg rounded-full w-full sm:w-auto',
  // Round icon-only button, used by FloatingWhatsApp
  floating: 'h-14 w-14 justify-center rounded-full shadow-xl',
};
 ...
 *
 * Text and icon are navy, not white: white on WhatsApp green (#25D366) is
 * 1.98:1 and fails WCAG AA; navy on the same green is 7.76:1.
 * Focus styling comes from the global :focus-visible ring in global.css.
 */
